...
import auth.ui.JPAUI.MyActionListener;

import auth.core.jdbc.JDBCUserAuthentication;
import auth.core.User;

public class JDBCUI extends UI {
	JLabel user;
	JLabel password;
	...
	JLabel info;
	public JDBCUI() {
		super("Authentication with JDBC");
	}
	...
	class MyActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (arg0.getActionCommand().equals("cancel")) {
				...
				User user = JDBCUserAuthentication.login(userField.getText(), passwordField.getText());
				if(user == null) {
					userField.setText("");
					passwordField.setText("");
